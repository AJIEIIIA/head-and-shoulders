...
CandleStickChart.prototype.fitView = function(){
    var raw = this.prepareRaw();
    this.layout = raw;
}

CandleStickChart.prototype.prepareRaw = function(){
  ...
  //layout container
     ...
     this.view.yAxis.style.left = helpers.stylePx(this.width - yWidth);
...
CandleStickChart.prototype.draw = function(){
	...
	if (i < this.data.length){
		...
		drawCandle.call(this, item, x, xStep, padding, calculateY, this.view.main_ctx);
	    }
